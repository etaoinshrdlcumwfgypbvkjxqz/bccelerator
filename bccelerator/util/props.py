...
EnumPropertyItem: _typing.TypeAlias = EnumPropertyItem3 | EnumPropertyItem4 | EnumPropertyItem5


@_typing.overload
def enum_property_item(identifier: str, name: str, description: str) -> EnumPropertyItem3:
    ...


@_typing.overload
def enum_property_item(identifier: str,
                       name: str,
                       description: str, *,
                       number: int) -> EnumPropertyItem4:
    ...
...
def enum_property_item(identifier: str,
                       ...
                       number: int | None = None) -> EnumPropertyItem:
    if icon is None:
        if number is None:
